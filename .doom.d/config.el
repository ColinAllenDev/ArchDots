...
(map! :leader
      (:prefix("c h" . "Help info from Clippy")
       :desc "Clippy describes function under pointer" "f" #'clippy-describe-function   ;; | SPC c h f |
       :desc "Clippy describes variable under pointer" "v" #'clippy-describe-variable)) ;; | SPC c h v |
